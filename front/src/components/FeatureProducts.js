...
import '../App.css';
import Imh6 from '../assets/svg/24-hours.svg'
import Imh7 from '../assets/svg/free-delivery.svg'
import Imh8 from '../assets/svg/payment-security.svg'
import Imh9 from '../assets/svg/tag.svg'
...
function Products() {
    ...
    const lastData = [
        {
            sName: Imh7,
            phrase1: "Free Shipping",
            phrase2: "For orders from $50"

        },
        {
            sName: Imh6,
            phrase1: "Support 24/7",
            phrase2: "Call us anytime"
        },
        {
            sName: Imh8,
            phrase1: "100% Safety",
            phrase2: "Only secure payments"
        },
        {
            sName: Imh9,
            phrase1: "Hot Offers",
            phrase2: "Discounts up to 90%"
        }
    ]
    ...
    return (
        <div className="site">
                                    ...
                                    <div className="owl-stage" style={{ transition: " all 0s ease 0s" }}>
                                        <div className="owl-item cloned" style={{ width: "1200px" }}>
                                            <a className="block-slideshow__item" href="">
                                                ...
                                                <span className="block-slideshow__item-details" style={{ "opacity": 1, "width": "270px" }}>installation of parts in the services of our partners</span><span className="block-slideshow__item-button" style={{ "opacity": 1, "backgroundColor": "#07DB96" }}>Shop Now </span></a></div>
                                    </div>
                                    <div className="owl-dots">
                                        <button role="button" className="owl-dot active" style={{ color: "green" }} >
                                            <span></span>
                                        </button>
                                                ...
                                                <div className="block-products-carousel__cell">
                                                    ...
                                                    <div className="product-card product-card--layout--grid">
                                                        ...
                                                        <div className="product-card__image">
                                                            <div className="image image--type--product"><a href="#" className="image__body"><img className="image__tag" src={require(`../assets/${product.productName}.jpeg`)} alt="" /></a></div>
                                                            ...
                                                            <div className="product-card__image">
                                                                <div className="image image--type--product">
                                                                    <a href="product-full.html" className="image__body">
                                                                        <img className="image__tag" src={require(`../assets/${product.productName}.jpeg`)} alt="" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div className="product-card__info">
            ...
            M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"></path></svg></button>
                ...
                <div className="block-space block-space--layout--divider-nl"></div>
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignContent: 'center', gap: '30px' }}>
                   { lastData && lastData.map((txt)=>(
                    <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', alignContent: 'center' }}>
                        <div><img src={txt.sName} alt="My Happy SVG" /></div>
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <span style={{ fontWeight: 'bolder' }} >{txt.phrase1}</span>
                            <p style={{ fontWeight: '1px' }} >{txt.phrase2}</p>
                        </div>
                    </div>
                   ))                
                   }
